...
namespace WindowsFormsApp1
{
    ...
    public class OperationPanel : Panel
    {
        ...
        {
            Width += Width * Convert.ToInt32((OperationButton.Number - 2) / 12);
    ...
    public partial class CalculatorWindow : Form
    {
        ...
        internal void AddPanel(string OperationName, OperationMethod operationMethod)
        {
        }
